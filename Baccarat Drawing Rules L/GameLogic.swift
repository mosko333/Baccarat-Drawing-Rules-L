...
class GameLogic {
    ...
    /// - 0 - Draw Correct
    /// - 1 - Player should draw first
    /// - 2 - player stands with a 6 - 7
    /// - 3 - Bank Rules
    /// - 666 - Error for unexpected values
    func isBankDrawCorrect(isPlayers3rdViewHidden players3rdViewIsHidden: Bool) -> Int {
        ...
        if !banks3rdViewisHidden && !players3rdViewIsHidden {
            ...
            if !isPlayerDrawCorrect() {
                if  !banks3rdViewisHidden {
                    ...
                    return true
                } else if isBankDrawCorrect(isPlayers3rdViewHidden: players3rdViewIsHidden) != 0 {
            ...
            if isBankDrawCorrect(isPlayers3rdViewHidden: players3rdViewIsHidden) != 0 {
                return true
            }
            else {
                return false
